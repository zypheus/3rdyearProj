                ...
                <x-card title="My Active Loans">
                    ...
                    <div class="space-y-4">
                        @forelse ($activeLoans as $loan)
                            <div class="block p-4 rounded-xl border border-slate-200 hover:border-indigo-300 transition-all duration-200 bg-white">
                                <a href="{{ route('loans.show', $loan) }}" class="block group">
                                ...
                                <div class="mt-3 pt-3 border-t border-slate-200 flex gap-2">
                                    <a href="{{ route('loans.payments.index', $loan) }}" class="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                        </svg>
                                        View Payments
                                    </a>
                                    <a href="{{ route('loans.payments.create', $loan) }}?advance=1" class="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-lg transition-all shadow-md hover:shadow-lg">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
